        ...
        if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
            ...
            if chat in saved_channel_ids:
                await app.edit_message_text(
                    ...
                    "Sorry! This channel is protected by **__Blue Power__**."
                )
                return
...
async def copy_message_with_chat_id(app, userbot, sender, chat_id, message_id, edit):
    ...
    try:
        ...
        if msg.media:
            ...
            if result:
                try:
                    await result.copy(LOG_GROUP)  # ✅ FIX: public channel log
                except Exception:
                    pass
            return
        elif msg.text:
            ...
            if result:
                try:
                    await result.copy(LOG_GROUP)  # ✅ FIX: public channel text log
                except Exception:
                    pass
            return
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **SpyLib ⚡**, built on Telethon(base), by Blue Power still in beta.__", buttons=buttons)
